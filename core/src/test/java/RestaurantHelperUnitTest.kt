...
import tin.novakovic.foodlocator.core.domain_layer.CuisineType
...
class RestaurantHelperUnitTest {
    ...
    fun setUp() {
        ...
        target = RestaurantHelper(mockJustEatRep)
    }

    private val mockRestaurantResponse = RestaurantResponse(
        restaurants = listOf(
            OldRestaurant(
                name = "Rogers Gaff",
                ratingAverage = 5.5,
                cuisineTypes = listOf(CuisineType(name = "English")),
                logoUrl = "url01"
            ),
            OldRestaurant(
                name = "Matilda's Frogs",
                ratingAverage = 5.5,
                cuisineTypes = listOf(CuisineType(name = "French")),
                logoUrl = "url02"
            ),
            OldRestaurant(
                name = "Luigi's Pizzeria",
                ratingAverage = 5.5,
                cuisineTypes = listOf(CuisineType(name = "Italian")),
                logoUrl = "url03"
            )
        )
    )
    ...
    private val mockRestaurants = listOf(
        Restaurant("Rogers Gaff", "5.5", "English", "url01"),
        Restaurant("Matilda's Frogs", "5.5", "French", "url02"),
        Restaurant("Luigi's Pizzeria", "5.5", "Italian", "url03")
    )
